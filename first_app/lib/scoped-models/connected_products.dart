...
mixin ProductsModel on ConnectedProductsModel {
  ...
  Future<bool> addProduct(
    ...
    try {
      final http.Response response = await http.post(
          'https://products-flutter-course-ms.firebaseio.com/products.json',
  ...
  Future<bool> updateProduct(
    ...
    return http
        .put(
            'https://products-flutter-course-ms.firebaseio.com/products/${selectedProduct.id}.json',
  ...
  Future<bool> deleteProduct() {
    ...
    return http
        .delete(
            'https://products-flutter-course-ms.firebaseio.com/products/${deletedProductId}.json')
        .then((http.Response response) {
      _isLoading = false;
      notifyListeners();
      return true;
